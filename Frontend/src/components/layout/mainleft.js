                ...
                <nav className='hidden  w-[100%] md:flex flex-col justify-between h-full'>
                    <ul className={`flex flex-col justify-start w-[100%] pb-2 gap-1`}>
                        ...
                        <Link to="/traintoexcellency/Frontend-build/">
                            <li className={`text-white ${location.pathname === '/' ? 'xl:bg-[#314969] ' : ''} xl:list-none xl:gap-3 flex xl:items-center xl:flex-row items-start flex-col text-gray-300 md:py-2 px-3 xl:hover:bg-[#314969] text-2xl font-medium rounded-xl `}>
                                <span className=" font-[200]">
                                     <Home className={`${location.pathname === '/traintoexcellency/Frontend-build/' ? ' xl:fill-transparent fill-white' : ''} w-8 h-8 stroke-2`}/>
                                </span>
                        ...
                        <Link to="/traintoexcellency/Frontend-build/explore">
                            <li className={`text-white ${location.pathname === '/traintoexcellency/Frontend-build/explore' ? 'xl:bg-[#314969] bg-none' : ''}  xl:list-none xl:gap-3 flex xl:items-center items-start xl:flex-row flex-col  md:py-2 px-3 xl:hover:bg-[#314969]  rounded-xl text-2xl font-medium`}>
                                <span className={` text-4xl`}>
                                <Search className={`${location.pathname === '/traintoexcellency/Frontend-build/explore' ? 'xl:stroke-2 stroke-[3px]' : ''}`}/>
                                </span>
                        ...
                        <Link to="/traintoexcellency/Frontend-build/profile">
                            <li className={`text-white ${location.pathname === '/traintoexcellency/Frontend-build/profile' ? 'xl:bg-[#314969] bg-none' : ''}  xl:list-none xl:gap-3 flex md:py-2 px-3 xl:hover:bg-[#314969]  rounded-xl xl:items-center items-start xl:flex-row flex-col text-gray-300 hover:text-gray-100 text-2xl font-medium`}>
                                <span className="material-symbols-outlined text-4xl">
                                    <CircleUserRound className={`${location.pathname === '/traintoexcellency/Frontend-build/profile' ? 'xl:stroke-2 stroke-[3px]'  : ''}`}/>
                                </span>
                        ...
                        <Link to="/traintoexcellency/Frontend-build/activity">
                            <li className={`text-white ${location.pathname === '/traintoexcellency/Frontend-build/activity' ? 'xl:bg-[#314969] bg-none' : ''}  xl:list-none xl:gap-3 flex md:py-2 px-3 xl:hover:bg-[#314969]  rounded-xl xl:items-center items-start xl:flex-row flex-col text-gray-300 hover:text-gray-100 text-2xl font-medium`}>
                                < span className="material-symbols-outlined text-4xl">
                                    <ChartArea className={`${location.pathname === '/traintoexcellency/Frontend-build/activity' ? 'xl:stroke-2 stroke-[3px]'  : ''}`}/>
                                </span>
